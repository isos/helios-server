...
class ElectionForm(forms.Form):
  ...
  use_advanced_audit_features = forms.BooleanField(required=False, initial=True,
  ...
  voting_starts_at = SplitDateTimeField(help_text = _("UTC date and time when voting begins"),
    label = _("Voting starts at"), widget=SplitSelectDateTimeWidget, required=False)
  voting_ends_at = SplitDateTimeField(help_text = _("UTC date and time when voting ends"),
    label = _("Voting ends at"), widget=SplitSelectDateTimeWidget, required=False)
...
class ElectionTimesForm(forms.Form):
  # times
  voting_starts_at = SplitDateTimeField(help_text = _('UTC date and time when voting begins'),
    label = _("Voting starts at"), widget=SplitSelectDateTimeWidget)
  voting_ends_at = SplitDateTimeField(help_text = _('UTC date and time when voting ends'),
    label = _("Voting ends at"),widget=SplitSelectDateTimeWidget)
...
class ElectionTimeExtensionForm(forms.Form):
  voting_extended_until = SplitDateTimeField(help_text = _("UTC date and time voting extended to"),
    label = _("Voting extended until"), widget=SplitSelectDateTimeWidget, required=False)
